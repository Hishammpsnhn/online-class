...
const studentSettings = ['Profile', 'Logout'];
const AdminSettings = ['Profile', 'Add Student', 'Dashboard', 'Logout'];
...
function Header() {
  ...
  const menuHandle = (setting: string) => {
                ...
                >
                  {user.isAdmin
                    ? AdminSettings.map((setting) => (
                      <MenuItem key={setting} onClick={() => menuHandle(setting)}>
